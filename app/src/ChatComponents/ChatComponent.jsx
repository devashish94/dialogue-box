  ...
  return (
    <>
      <div className=' flex flex-col h-full justify-between flex-grow rounded-md space-y-2 relative oveflow-y-auto'>
        ...
        {/* <div className='flex-grow rounded-md flex flex-col px-3 py-8 space-y-2 overflow-y-auto transition-all duration-500 ease-in-out bg-red-100 hover:bg-red-200'> */}
        <div className='flex-1 h-full rounded-md flex flex-col px-3 py-8 space-y-2 overflow-y-auto'>
          {
        ...
        <div className={`${emojiPicker ? 'h-80' : 'h-0'} w-full bg-black flex justify-center items-center transition-all duration-[250ms] ease-in-out text-white`}>Emoji Picker</div>
