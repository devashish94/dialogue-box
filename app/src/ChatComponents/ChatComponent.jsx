...
export default function ChatComponent({ username, room, conversations, submitAction, sidebar }) {

  return (
    <div className=' flex flex-col justify-between bg-neutral-900 flex-grow rounded-md space-y-1 px-2 py-3'>
      <nav className="flex w-full items-center space-x-6 px-3 bg-neutral-900">
        ...
        <button className="text-xl font-bold w-full hover:bg-neutral-700 py-2 rounded-md">{room}</button>
      ...
      <div className='flex-grow rounded-md flex flex-col px-3 py-8 space-y-8 overflow-y-auto'>
        {
      ...
      <form onSubmit={submitAction} className='w-full flex items-center space-x-3 px-1 py-1'>
